...
const AdminLogin = () => {
  ...
  return (
    <>
      <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
        <div className="min-h-screen bg-gradient-to-br from-purple-200 via-purple-100 to-lavender-50 flex flex-col items-center justify-center px-6 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Welcome back to your culinary journey</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-right">
                <button 
                  ...
                  className="text-sm text-[#9A61B0] hover:text-[#8A50A0] hover:underline transition-colors font-medium"
                >
                  Forgot password?
                </button>
              </div>
      ...
      {/* Forgot Password Modal - Rendered outside GoogleOAuthProvider */}
      <ForgotPasswordModal 
