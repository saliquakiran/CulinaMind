...
const SignUpWithPreferences = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Redirect to login page with a flag indicating this is a new user
  ...
  const handleGoogleSuccess = async (credentialResponse: any) => {
    try {
      ...
      // For Google sign-up, redirect to login with new user flag
      navigate("/login?newUser=true");
    } catch (error) {
...
export default SignUpWithPreferences;
