...
def test_multi_user_context_isolation():
    ...
    user1_profile_file = context_manager._get_file_path(context_manager.ContextType.USER_PROFILE, "user_123")
    user2_profile_file = context_manager._get_file_path(context_manager.ContextType.USER_PROFILE, "user_456")
